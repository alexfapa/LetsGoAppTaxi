package br.com.tutorialandroid.splashscreen.network;
...
public class HttpConnection {
    public static String getSetDataWeb(String url, String method, MessageEB m){//, ServerResponse serv
        ...
        try{
            ...
            //valores.add(new BasicNameValuePair("id-user", m.getUser() +"" ));
