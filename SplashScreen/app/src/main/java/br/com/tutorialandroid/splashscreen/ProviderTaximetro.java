...
public class ProviderTaximetro extends ActionBarActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        double latitude = Double.parseDouble(ProviderTaximetro.getInSharedPreferences(this, LATITUDE_KEY, "-3.685668"));
        double longitude = Double.parseDouble(ProviderTaximetro.getInSharedPreferences(this, LONGITUDE_KEY, "-40.344284"));
        ...
        customAddMarker(latLng, "Minha localização", "O Marcador 1 foi reposicionado");
...
*/
    ...
    public void onEvent(MessageEB m) {
        if (m.getClassName().equalsIgnoreCase(ProviderTaximetro.class.getName())) {
