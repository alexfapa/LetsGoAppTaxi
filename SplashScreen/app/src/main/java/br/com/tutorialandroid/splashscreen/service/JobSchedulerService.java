...
import br.com.tutorialandroid.splashscreen.domain.User;
import br.com.tutorialandroid.splashscreen.loginActivity.conexoes.ServerResponse;
import br.com.tutorialandroid.splashscreen.mapacomweb.TrackingActivity;
import br.com.tutorialandroid.splashscreen.network.HttpConnection;
...
public class JobSchedulerService extends JobService
    ...
    //UTILIZAMOS O LOCATION API
    private GoogleApiClient mGoogleApiClient;
    private JobParameters mJobParameters;
    private MessageEB mMessageEB;
    private LocationRequest mLocationRequest;

    private ServerResponse serv;
...
/*
 //QUANDO VOLTAR A MANDAR COORDENADAS PARA O BANCO
        mMessageEB = new MessageEB();
        mMessageEB.setUser(Constants.ID_UNICO);
        mMessageEB.setLocation(location);
        mMessageEB.setClassName( ProviderFragmentV2.class.getName() );

        EventBus.getDefault().post( mMessageEB );

        new MyAsyncTask(this).execute(mJobParameters);

        ProviderFragmentV2.saveInSharedPreferences(this, ProviderFragmentV2.LATITUDE_KEY, String.valueOf( location.getLatitude() ));
        ProviderFragmentV2.saveInSharedPreferences(this, ProviderFragmentV2.LONGITUDE_KEY, String.valueOf( location.getLongitude() ));
        ProviderFragmentV2.saveInSharedPreferences(this, ProviderFragmentV2.ALTITUDE_KEY, String.valueOf( location.getAltitude() ));
...
*/
    ...
    private class MyAsyncTask extends AsyncTask<JobParameters, Void, Void>{
        ...
        protected Void doInBackground(JobParameters... params) {
            ...
            HttpConnection.getSetDataWeb("http://www.letsgosobral.esy.es/location_api/package/ctrl/CtrlMap.php",
                    "send-map-coords",
                    mMessageEB);
